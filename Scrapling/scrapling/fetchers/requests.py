...
class Fetcher(BaseFetcher):
    ...
    def post(cls, url: str, **kwargs: Unpack[DataRequestParams]) -> Response:
        return __FetcherClientInstance__.post(
            url, **_merge_selector_config(cls, kwargs)
        )
    ...
    def delete(cls, url: str, **kwargs: Unpack[DataRequestParams]) -> Response:
        return __FetcherClientInstance__.delete(
            url, **_merge_selector_config(cls, kwargs)
        )
...
class AsyncFetcher(BaseFetcher):
    ...
    def get(cls, url: str, **kwargs: Unpack[GetRequestParams]) -> Awaitable[Response]:
        return __AsyncFetcherClientInstance__.get(
            url, **_merge_selector_config(cls, kwargs)
        )

    @classmethod
    def post(cls, url: str, **kwargs: Unpack[DataRequestParams]) -> Awaitable[Response]:
        return __AsyncFetcherClientInstance__.post(
            url, **_merge_selector_config(cls, kwargs)
        )

    @classmethod
    def put(cls, url: str, **kwargs: Unpack[DataRequestParams]) -> Awaitable[Response]:
        return __AsyncFetcherClientInstance__.put(
            url, **_merge_selector_config(cls, kwargs)
        )

    @classmethod
    def delete(
        cls, url: str, **kwargs: Unpack[DataRequestParams]
    ) -> Awaitable[Response]:
        return __AsyncFetcherClientInstance__.delete(
            url, **_merge_selector_config(cls, kwargs)
        )
