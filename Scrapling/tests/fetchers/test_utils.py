...
_extract_encoding = getattr(
    ResponseFactory, "_ResponseFactory__extract_browser_encoding"
)
...
def test_browser_encoding_quoted_charset():
    ...
    assert (
        _extract_encoding('text/plain; charset="windows-1252"; boundary=x')
        == "windows-1252"
    )
...
class TestCreateInterceptHandler:
    ...
    def test_blocks_exact_domain(self):
        handler = create_intercept_handler(
            disable_resources=False, blocked_domains={"ads.example.com"}
        )
    ...
    def test_blocks_subdomain(self):
        handler = create_intercept_handler(
            disable_resources=False, blocked_domains={"example.com"}
        )
    ...
    def test_resource_blocking_takes_priority_over_domain(self):
        ...
        handler = create_intercept_handler(
            disable_resources=True, blocked_domains={"example.com"}
        )
    ...
    def test_domain_blocking_with_resources_disabled(self):
        ...
        handler = create_intercept_handler(
            disable_resources=True, blocked_domains={"tracker.io"}
        )
    ...
    def test_multiple_blocked_domains(self):
        handler = create_intercept_handler(
            disable_resources=False, blocked_domains={"ads.com", "tracker.io"}
        )
...
class TestCreateAsyncInterceptHandler:
    ...
    async def test_blocks_domain(self):
        handler = create_async_intercept_handler(
            disable_resources=False, blocked_domains={"ads.example.com"}
        )
    ...
    async def test_blocks_subdomain(self):
        handler = create_async_intercept_handler(
            disable_resources=False, blocked_domains={"tracker.io"}
        )
