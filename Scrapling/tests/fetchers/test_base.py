...
class TestBaseFetcher:
    ...
    def test_configure_multiple_parameters(self):
        ...
        BaseFetcher.configure(huge_tree=False, keep_comments=True, adaptive=True)
        ...
        # Reset
        BaseFetcher.configure(huge_tree=True, keep_comments=False, adaptive=False)
    ...
    def test_generate_parser_arguments(self):
        ...
        BaseFetcher.configure(
            huge_tree=False, adaptive=True, adaptive_domain="example.com"
        )
